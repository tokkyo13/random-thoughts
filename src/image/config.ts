...
type AreaSpec = {
  ...
  // and is also the copy kept in content/image/. Editing a list affects only images uploaded
  // afterwards.
...
export const AREAS: Record<string, AreaSpec> = {
  ...
  art: { autoCover: true, types: { art: [640, 896, 1792], cover: [640, 896, 1792] } },
};
